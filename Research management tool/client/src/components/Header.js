        ...
        if(state == 1){
            return(
                <>
                    ...
                    <td>
                        <Link to="/submit" className="nav-link" aria-current="page" style={{color: "white"}}>Submit</Link>
                    </td>
                    <td>
                        <Link to="/studentsubmissions" className="nav-link" aria-current="page" style={{color: "white"}}>Submissions</Link>
                    </td>
                    <td>
                        <Link to="/submissions" className="nav-link" aria-current="page" style={{color: "white"}}>Notices</Link>
                    </td>
                    <td>
